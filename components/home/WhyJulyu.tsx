...
export default function WhyJulyu() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black mb-4">
            Why <span className="text-green-500">Julyu</span>?
          </h2>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Grocery shopping shouldn&apos;t feel like a guessing game. We built Julyu to give everyone access to the pricing intelligence that used to be reserved for big retailers.
          </p>
        </div>
