...
const defaultContent: HowItWorksContent = {
  title: 'How It Works',
  subtitle: 'Start saving in three simple steps. No complicated setup required.',
  steps: [
    {
      number: 1,
...
export default function HowItWorks({ content }: HowItWorksProps) {
  ...
  return (
    <section className="py-24 px-[5%] bg-gradient-to-b from-black to-green-950/20">
          ...
          <h2 className="text-4xl md:text-5xl font-black mb-4">
            {data.title?.includes(' ') ? (
              <>
                ...
                <span className="text-green-500">{data.title.split(' ').slice(-1)[0]}</span>
              </>
            ) : (
