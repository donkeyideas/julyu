...
export async function findLocalProductMatches(
 ...
 // A local match is only useful if we have a cached price for it —
 // otherwise we'd be hiding the item from the live APIs (Kroger /
 // Walmart / Flipp / Target) and the user gets "matched but $0".
