...
DROP POLICY IF EXISTS "Admin can view rate limits" ON rate_limit_config;
DROP POLICY IF EXISTS "Admin can update rate limits" ON rate_limit_config;
DROP POLICY IF EXISTS "Admin can view usage tracking" ON api_usage_tracking;
DROP POLICY IF EXISTS "Admin can manage usage tracking" ON api_usage_tracking;
